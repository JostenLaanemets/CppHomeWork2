...
bool RG::Homework2::assignment1()
{
    ...
    int &ilr1 = i;
    // Loo muutuja irr mis on int rreference tüüpi ja väärtusega 5 // Kontrollis on muutuja väärtu 2
    int &&irr { 2 }; 
    // Loo muutuja ilr2 mis on int lreference tüüpi ja väärtusega i // Sama siin
    int &ilr2 {irr};
